...
% img = imfinfo(baseimg);
nMosaicCol = 50; % column number of the mosaic poicture
nMosaicRow = 70; % row number of the mosaic poicture
nTile = 1200; % the max number of tile images
radius = 5; % radius of proximity
tweekRatio = 0.3; % tweek ratio for the tile image
mixRaio = 0.5;
